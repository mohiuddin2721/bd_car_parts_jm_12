...
const Banner1 = () => {
    return (
        <section style={{backgroundImage: "url(https://i.ibb.co/CH4vPkt/bgCar3.webp)"}} className="banner-container bg-banner h-screen lg:h-[90vh] bg-fixed bg-no-repeat bg-cover mb-4 text-white">
